...
class CreateEmissionStandard2sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('emission_standard2s', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('emission_standard2s');
    }
}
