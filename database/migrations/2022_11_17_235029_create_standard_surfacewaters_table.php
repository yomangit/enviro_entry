...
class CreateStandardSurfacewatersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('standard_surfacewaters', function (Blueprint $table) {
            $table->id();
            $table->string("name");
    ...
    {
        Schema::dropIfExists('standard_surfacewaters');
    }
}
