...
class CreateGroundWaterMonthStandardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ground_water_month_standards', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ground_water_month_standards');
    }
}
