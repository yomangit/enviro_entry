...
class CreateSoilqualitystandardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('soilqualitystandards', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('soilqualitystandards');
    }
}
