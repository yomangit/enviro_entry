...
class CreateQualityStdDrinkWatersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quality_std_drink_waters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('quality_std_drink_waters');
    }
}
