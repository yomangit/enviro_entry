...
class CreateMarineSurfacewatersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('marine_surfacewaters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('marine_surfacewaters');
    }
}
