...
Route::get('/dashboard/dataentry/arp2', function () {
    return view('dashboard.dataentry.arp2', ["tittle" => "ARP-02", "breadcrumb" => "Data Entry"]);
})->middleware('auth');
...
Route::resource('/surfacewater/marinesurfacewater', MarinesurfacewaterController::class)->middleware('admin');
...
Route::resource('/airquality/ambien', AmbienController::class)->middleware('admin');
...
Route::resource('/airquality/emission', EmissionController::class)->middleware('admin');
Route::resource('/airquality/emission2', Emission2Controller::class)->middleware('admin');
...
Route::resource('/hydrometric/dischargemanual', DischargeManualController::class)->middleware('admin');
...
Route::resource('/tailing', TailingController::class)->middleware('admin');
...
Route::resource('/soilquality',SoilQualityController::class)->middleware('admin');
...
Route::resource('/wastewater',WastewaterController::class)->middleware('admin');
Route::resource('/weather/rainfall/rainfallpointid',RainfallPointIdController::class)->middleware('admin');
Route::resource('/weather/rainfall',RainfallController::class)->middleware('admin');
Route::resource('/weather/evaporation/evaporationpointid',EvaporationPointIdController::class)->middleware('admin');
Route::resource('/weather/evaporation',EvaporationController::class)->middleware('admin');
// export & import
...
Route::get('/export/marinesurfacewater/quality', [QualityStandardMarineController::class, 'ExportQualityStandardMarine'])->middleware('admin');
