            ...
            <div class="">
                <div class="card card-primary card-outline">
                    <div class="card-header p-0 ">
                        ...
                        @endif
                        <a href="/blasting/pointid/create" class="btn bg-gradient-secondary btn-xs ml-2 my-1"><i class="fas fa-plus mr-1 mt"></i>Add Data</a>
                        <a href="/export/blasting/pointid" class="btn  bg-gradient-secondary btn-xs my-1" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
                        ...
                        <div class=" card-tools p-1 mt-1 mr-2 form-inline">
                        ...
                        <div class="card-tools mt-2 form-inline">
                            <div class="col-4">
                                <div class="d-flex justify-content-start">
                                    <p>Showing {{ $PointID->firstItem() }} to {{$PointID->lastItem() }} of {{ $PointID->total() }}</p>
                                </div>
                            </div>
