                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="card-tools row">
                                                    {{-- <form action="/dashboard/blasting/pointid" class="form-inline">
                                                    ...
                                                    <form action="/dashboard/blasting/pointid">
                                                        <button type="submit"
                                                ...
                                                <a href="/dashboard/blasting/pointid/create"
                                                            ...
                                                            @foreach ($PointID as  $point_id)
                                                                <tr style="font-size: 12px">
                                                                    ...
                                                                    <td>
                                                                            ...
                                                                            {{-- <a href="/dashboard/blasting/pointid/{{ $point_id->failed_at }}"
                                                                                class="btn btn btn-outline-primary btn-xs btn-group"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title="Detail">
                                                                                <i class="far fa-eye"></i>
                                                                            </a> --}}
                                                                            <a href="/dashboard/blasting/pointid/{{ $point_id->created_at }}/edit"
                                                                            ...
                                                                            <form
                                                                                action="/dashboard/blasting/pointid/{{ $point_id->created_at }}"
                                                                                method="POST"
                                                                                class="d-inline">
                                                                                @method('delete')
                                                                                @csrf
