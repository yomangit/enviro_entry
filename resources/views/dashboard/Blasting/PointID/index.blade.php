                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="card-tools row">
                                                    {{-- <form action="/blasting/pointid" class="form-inline">
                                                ...
                                                <a href="/blasting/pointid/create"
                                                class="btn bg-gradient-secondary btn-xs mt-2"><i
                                                    class="fas fa-plus mr-1 mt"></i>Add Data</a>
                                                    <a href="/export/blasting/pointid" class="btn  bg-gradient-secondary btn-xs mt-2" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
                                            ...
                                            @if ($PointID->count())
                                                <div class="card-body table-responsive ">
                                                    <table role="grid" id="example2"
                                                        ...
                                                        @endphp
                                                            @foreach ($PointID as  $point_id)
                                                                <tr style="font-size: 12px">
                                                                    <td>{{ $no++ }}</td>
                                                                    <td>

                                                                            {{-- <a href="/blasting/pointid/{{ $point_id->failed_at }}"
                                                                                class="btn btn btn-outline-primary btn-xs btn-group"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title="Detail">
                                                                                <i class="far fa-eye"></i>
                                                                            </a> --}}
                                                                            <a href="/blasting/pointid/{{ $point_id->created_at }}/edit"
                                                                            ...
                                                                            <form
                                                                                action="/blasting/pointid/{{ $point_id->created_at }}"
                                                                                method="POST"
                                                                                class="d-inline">
                                                                                @method('delete')
                                                                                @csrf
                                                    ...
                                                    <div class="card-tools row form-inline">
                                                        <div class="col-4">
                                                            <div class="d-flex justify-content-start">
                                                                <small>Showing {{ $PointID->firstItem() }} to {{
                                            ...
                                            <div class="modal fade" id="modal-default">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/import/blasting/pointid" method="POST" enctype="multipart/form-data">
                                                            @csrf
