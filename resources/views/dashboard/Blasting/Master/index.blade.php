        ...
        <div class="container-fluid">
            <div class="card card-secondrary card-tabs">
                <div class="card-header p-0 pt-1">
                    ...
                    @endif
                    @can('admin')
                    <a href="/blasting/pointid" class="btn bg-gradient-info btn-xs ml-5 mt-3">Code Sample</a>
                    <a href="/blasting/tablestandard" class="btn bg-gradient-info btn-xs  mt-3">Table Standard</a>
                    @endcan
                </div>
                <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <a href="/blasting/create" class="btn bg-gradient-secondary btn-xs mt-2"><i class="fas fa-plus mr-1 mt"></i>Add Data</a>
                                        ...
                                        <table role="grid" id="example2" class="table table-bordered table-sm table-hover ">
                                            ...
                                            <tbody style="text-align: center">
                                                ...
                                                <tr style="font-size: 12px">
                                                    <td>{{ $no++ }}</td>
                                                    <td>
                                                        <a href="/blasting/{{ $blast->created_at }}/edit" class="btn btn-outline-warning btn-xs btn-group" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="fas fa-pen"></i>
                                                        </a>
                                                        <form action="/blasting/{{ $blast->created_at }}" method="POST" class="d-inline">
                                                            @method('delete')
                                                            @csrf
