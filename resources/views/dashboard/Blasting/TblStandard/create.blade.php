    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="/blasting/tablestandard" method="post" checked enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="row">
                        <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="ci" type="text" class="form-control form-control-sm @error('ci') is-invalid @enderror" value="{{ old('ci') }}" />
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="frequency" type="text" class="form-control form-control-sm @error('frequency') is-invalid @enderror" value="{{ old('frequency') }}" />
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="ppv" type="text" class="form-control form-control-sm @error('ppv') is-invalid @enderror" value="{{ old('ppv') }}" />
                                            @error('ppv')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="kualitas_bangunan" type="text" class="form-control form-control-sm @error('kualitas_bangunan') is-invalid @enderror" value="{{ old('kualitas_bangunan') }}" />
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="noise_level" type="text" class="form-control form-control-sm @error('noise_level') is-invalid @enderror" value="{{ old('noise_level') }}" />
                                            @error('noise_level')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
