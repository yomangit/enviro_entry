        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header p-0 ">
                    ...
                    <a href="/airquality/noisemeter/noise/codesamplenm/create" class="btn bg-gradient-secondary btn-xs  ml-2"><i class="fas fa-plus mr-1 mt"></i>Add Data</a>
                    <a href="/export/codesamplenm" class="btn  bg-gradient-secondary btn-xs my-1" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
