...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="/airquality/noisemeter/noise/locationnoise">{{ $tittle }}</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- SELECT2 EXAMPLE -->
            <div class="card card-primary w-50 card-outline">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="/airquality/noisemeter/noise/locationnoise" method="post" checked enctype="multipart/form-data" autocomplete="off">
                        @csrf
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        <label style="font-size: 12px" class="col-sm-4 col-form-label">Name Location</label>
                                        <div class="col-sm-7">
