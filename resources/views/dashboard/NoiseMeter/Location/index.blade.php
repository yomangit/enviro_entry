            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Code Location</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary card-outline">
                <div class="card-header p-0 ">
                    ...
                    <div class=" card-tools p-1 my-1 mr-2 form-inline">
                        <form action="/airquality/noisemeter/noise/locationnoise">
                    ...
                    <a href="/airquality/noisemeter/noise/locationnoise/create" class="btn bg-gradient-secondary btn-xs ml-2 my-1"><i class="fas fa-plus mr-1 mt"></i>Add Data</a>
                    <a href="/exportlocation" class="btn  bg-gradient-secondary btn-xs my-1" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
                            ...
                            <tbody style="text-align: center">
                                ...
                                <tr style="font-size: 12px">
                                    ...
                                    <td>
                                        ...
                                        <a href="/airquality/noisemeter/noise/locationnoise/{{ $code->id }}/edit" class="btn btn-outline-warning btn-xs btn-group" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="fas fa-pen"></i>
                                        </a>
                                        <form action="/airquality/noisemeter/noise/locationnoise/{{ $code->id }}" method="POST" class="d-inline">
                                            @method('delete')
                                            @csrf
