            ...
            <div class="">
                <div class="card card-primary card-outline">
                    <div class="card-header p-0 ">
                        ...
                        <a href="/groundwater/standard/create" class="btn bg-gradient-secondary btn-xs ml-2 my-1"><i class="fas fa-plus mr-1 mt"></i>Add Data</a>
                        <a href="/export/groundwater/standart" class="btn  bg-gradient-secondary btn-xs my-1" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
                            ...
                            <table role="grid" id="example2" class="table table-bordered table-hover ">
                                ...
                                <tbody style="text-align: center">
                                    ...
                                    <tr style="font-size: 12px">
                                        ...
                                        <td>{{ $code->r }}</td>
                                        <td>
                                            <a href="/groundwater/standard/{{ $code->id }}/edit" class="btn btn-outline-warning btn-xs btn-group" data-toggle="tooltip" data-placement="top" title="Edit">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <form action="/groundwater/standard/{{ $code->id }}" method="POST" class="d-inline">
                                                @method('delete')
                                                @csrf
                    ...
                    <div class="card-footer p-0 ">
                        <div class="row ">
                            <div class="col-6 col-md-4 form-inline ">
                                ...
                                <h6 class="ml-2 p-0 mt-1">Showing {{ $Master->firstItem() }} to
                    ...
                    <div class="modal fade" id="modal-default">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="/import/groundwater/standart" method="POST" enctype="multipart/form-data">
                                    @csrf
