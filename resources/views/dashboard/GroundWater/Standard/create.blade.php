    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="/dashboard/groundwater/standard" method="post" checked enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="form-group row">
                                        <label style="font-size: 12px"
                                            ...
                                            (m)</label>
                                        <div class="col-sm-7">
                                            <input name="d_pipe" type="number" step="0.00001"
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="tt" type="number" step="0.00001"
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="r" type="number" step="0.00001"
