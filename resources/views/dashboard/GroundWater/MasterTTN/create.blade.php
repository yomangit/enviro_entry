                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="well" type="number" step="0.01" class="form-control form-control-sm @error('well') is-invalid @enderror" value="{{ old('well') }}" />
                                            @error('well')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="well_water" type="number" step="0.01" class="form-control form-control-sm @error('well_water') is-invalid @enderror" value="{{ old('well_water') }}">
                                            @error('well_water')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="h" type="number" step="0.01" value="{{ old('h') }}" class="form-control form-control-sm @error('h') is-invalid @enderror">
                                            @error('h')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="water_volume" type="number" step="0.01" class="form-control form-control-sm  @error('water_volume') is-invalid @enderror" value="{{ old('water_volume') }}" />
                                            @error('water_volume')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="ph" type="number" step="0.01" value="{{ old('ph') }}" class="form-control form-control-sm @error('ph') is-invalid @enderror">
                                            @error('ph')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="redox" type="number" step="0.01" class="form-control form-control-sm @error('redox') is-invalid @enderror" value="{{ old('redox') }}" />
                                            @error('redox')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
