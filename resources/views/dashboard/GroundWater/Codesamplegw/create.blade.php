                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="total" type="number" step="0.0001" class="form-control form-control-sm @error('total') is-invalid @enderror" value="{{ old('total') }}" />
                                            @error('total')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="gl" type="number" step="0.0001" class="form-control form-control-sm @error('gl') is-invalid @enderror" value="{{ old('gl') }}" />
                                            @error('gl')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="rl" type="number" step="0.0001" class="form-control form-control-sm @error('rl') is-invalid @enderror" value="{{ old('rl') }}" />
                                            @error('rl')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
