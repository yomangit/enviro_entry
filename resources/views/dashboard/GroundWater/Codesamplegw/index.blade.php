                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <a href="/groundwater/mastergw/codesamplegw/create"
                                                ...
                                                <tbody style="text-align: center">
                                                    ...
                                                    <tr style="font-size: 12px">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="/groundwater/mastergw/codesamplegw/{{ $code->failed_at }}/edit"
                                                                class="btn btn-outline-warning btn-xs btn-group"
                                                                data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <i class="fas fa-pen"></i>
                                                            </a>
                                                            <form
                                                                action="/groundwater/mastergw/codesamplegw/{{ $code->failed_at }}"
