                ...
                <div class="card card-primary card-outline">
                    <div class="card-header p-0 ">
                        ...
                        <div class="card-tools row p-2 mr-1 form-inline">
                            <form action="/groundwater/mastergw/codesamplegw">
                        ...
                        <a href="/groundwater/mastergw/codesamplegw/create" class="btn bg-gradient-secondary btn-xs ml-2 my-1"><i class="fas fa-plus mr-1 mt"></i>Add Data</a>
                        <a href="/exportcodesamplegw" class="btn  bg-gradient-secondary btn-xs my-1" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
