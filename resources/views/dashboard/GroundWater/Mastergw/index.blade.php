            ...
            <div class="card card-primary card-outline">
                <div class="card-header p-0 ">
                    ...
                    <div class="card-tools row p-2 mr-1 form-inline">
                        <form action="/groundwater/mastergw" class="form-inline" autocomplete="off">
                    ...
                    @can('admin')
                    <a href="/groundwater/mastergw/codesamplegw" class="btn bg-gradient-info btn-xs ml-2 mt-2">Code Sample</a>
                    @endcan
                ...
                <div class="card-body table-responsive">
                    <section class="content ">
                        ...
                        <div class="d-flex justify-content-start">
                            <a href="/groundwater/mastergw/create" class="btn bg-gradient-secondary btn-xs ml-1"><i class="fas fa-plus mr-1"></i>Add Data</a>

                            <a href="/exportmastergw" class="btn  bg-gradient-secondary btn-xs ml-1" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
                ...
                <div class="modal fade" id="modal-default">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="/importmastergw" method="POST" enctype="multipart/form-data">
                                @csrf
