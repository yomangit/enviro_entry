                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="well" type="text" class="form-control form-control-sm @error('well') is-invalid @enderror" value="{{ old('well') }}" />
                                            @error('well')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="well_water" type="text" class="form-control form-control-sm @error('well_water') is-invalid @enderror" value="{{ old('well_water') }}">
                                            @error('well_water')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="h" type="text" value="{{ old('h') }}" class="form-control form-control-sm @error('h') is-invalid @enderror">
                                            @error('h')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="water_volume" type="text" class="form-control form-control-sm  @error('water_volume') is-invalid @enderror" value="{{ old('water_volume') }}" />
                                            @error('water_volume')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="ph" type="text" value="{{ old('ph') }}" class="form-control form-control-sm @error('ph') is-invalid @enderror">
                                            @error('ph')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        <label style="font-size: 11px" class="col-sm-4 col-form-label"> Rain Before Sampling</label>
                                        <div class="col-sm-7">
                                            <div class="icheck-success d-inline col-sm-7">

                                                <input type="radio" name="rain_before_sampling" value="Ya" checked id="rain1">
                                                <label style="font-size: 12px" for="rain1">Yes
                                                </label>
                                            </div>
                                            <div class="icheck-success d-inline">
                                                <input type="radio" name="rain_before_sampling" value="Tidak" id="rain2">
                                                <label style="font-size: 12px" for="rain2">No
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="icheck-success d-inline col-sm-7">
                                                ...
                                                <label style="font-size: 12px" for="rainSampling1">Yes
                                                </label>
                                            </div>
                                            <div class="icheck-success d-inline">

                                                <input type="radio" name="rain_during_sampling" @error('rain_during_sampling') checked @enderror value="Tidak" id="rainSampling2">
                                                <label style="font-size: 12px" for="rainSampling2">No
                                                </label>
                                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        <label style="font-size: 12px" class="col-sm-4 col-form-label">Oil Layer
                                        </label>
                                        <div class="col-sm-7">
                                            <div class="icheck-success d-inline col-sm-7">
                                                <input type="radio" name="oil_layer" value="Tidak" checked id="oilLayer1">
                                                <label style="font-size: 12px" for="oilLayer1">Yes
                                                </label>
                                            </div>
                                            <div class="icheck-success d-inline">
                                                <input type="radio" name="oil_layer" value="Tidak" id="oilLayer2">
                                                <label style="font-size: 12px" for="oilLayer2">No
                                                </label>
                                            </div>
