        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="/dashboard/groundwater/mastergw/{{ $Master->failed_at }}" method="post"
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group date" id="reservationdate4" data-target-input="nearest">
                                                <input type="text" name="date"
                                                    ...
                                                    value="{{ old('date', date('d-m-Y',strtotime($Master->date))) }}" />
                                                @error('date')
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group date" id="timepicker"
                                                ...
                                                <input name="start_time" type="text"
                                                    value="{{ old('start_time', $Master->start_time) }}"
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group date" id="timepicker1"
                                                ...
                                                <input name="stop_time" type="text"
                                                    value="{{ old('stop_time', $Master->stop_time) }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="well_water" type="number" step="0.01"
                                                    ...
                                                    value="{{ old('well_water',$Master->well_water) }}">
                                                @error('well_water')
                                                    <span
                                                        class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="water_volume" type="number" step="0.01"
                                                    ...
                                                    value="{{ old('water_volume',$Master->water_volume) }}" />
                                                @error('water_volume')
                                                    <span
                                                        class=" invalid-feedback">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="temperatur" type="number" step="0.01"
                                                    ...
                                                    value="{{ old('temperatur',$Master->temperatur) }}" />
                                                @error('temperatur')
                                                    <span
                                                        class=" invalid-feedback">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="salinity" type="number" step="0.01"
                                                    ...
                                                    value="{{ old('salinity',$Master->salinity) }}" />
                                                @error('salinity')
                                                    <span
                                                        class=" invalid-feedback">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="turbidity" type="number" step="0.01"
                                                    ...
                                                    value="{{ old('turbidity',$Master->turbidity) }}" />
                                                @error('turbidity')
                                                    <span
                                                        class=" invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    <input type="radio" name="water_color" value="Normal"
                                                        {{ $Master->water_color == 'Normal' ? 'checked' : '' }} 
                                                        id="watercolor1">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    <input type="radio" name="water_color" value="Agak Keruh"
                                                        {{ $Master->water_color == 'Agak Keruh' ? 'checked' : '' }}
                                                        id="watercolor2">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    <input type="radio" name="water_color" value="Keruh"
                                                        {{ $Master->water_color == 'Keruh' ? 'checked' : '' }} id="watercolor3">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    ...
                                                    <input type="radio" name="odor" value="Ya"
                                                        {{ $Master->odor == 'Ya' ? 'checked' : '' }} id="waterScan1">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    ...
                                                    <input type="radio" name="odor" value="Tidak"
                                                        {{ $Master->odor == 'Tidak' ? 'checked' : '' }} id="waterScant2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    ...
                                                    <input type="radio" name="rain_before_sampling" value="Ya"
                                                        {{ $Master->rain_before_sampling == 'Ya' ? 'checked' : '' }} id="rain1">
                                                    <label style="font-size: 12px" for="rain1">Ya
                                                    </label>
                                                </div>
                                                <div class="icheck-success d-inline">
                                                    <input type="radio" name="rain_before_sampling" value="Tidak"
                                                        {{ $Master->rain_before_sampling == 'Tidak' ? 'checked' : '' }} id="rain2">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    ...
                                                    <input type="radio" name="rain_during_sampling" value="Ya"
                                                        {{ $Master->rain_during_sampling == 'Ya' ? 'checked' : '' }}
                                                        id="rainSampling1">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    ...
                                                    <input type="radio" name="rain_during_sampling" value="Tidak"
                                                        {{ $Master->rain_during_sampling == 'Tidak' ? 'checked' : '' }}
                                                        id="rainSampling2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="source_pollution" type="text"
                                                    ...
                                                    value="{{ old('source_pollution',$Master->source_pollution) }}" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="sampler" type="text"
                                                    ...
                                                    value="{{ old('sampler',$Master->sampler) }}" />
                                                @error('sampler')
                                                    <span
                                                        class=" invalid-feedback">{{ $message }}</span>
                                                @enderror
