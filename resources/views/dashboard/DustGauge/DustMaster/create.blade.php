    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="/dashboard/dustgauge/dust" method="post" checked enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="icheck-success d-inline col-sm-7">
                                                <input type="radio" name="vb_dirt"
                                                    value="Yes" checked id="watercolor1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="icheck-success d-inline col-sm-7">
                                                ...
                                                <input type="radio" name="vb_algae" value="Yes" checked
                                                    id="waterScan1">
                                            ...
                                            <div class="icheck-success d-inline">
                                                ...
                                                <input type="radio" name="vb_algae" value="No"
                                                    id="waterScant2">
                                                <label style="font-size: 12px"
                                                    for="waterScant2">No
                                                </label>
