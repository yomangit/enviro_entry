            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard/monitoring/freshwater/master">Home</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="/dashboard/monitoring/freshwater/master" method="post" checked enctype="multipart/form-data" autocomplete="off">
                        @csrf
                            ...
                            <section class="content">
                                <div class="container-fluid">
                                    ...
                                    <div class="card card-default">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                        <form action="/dashboard/monitoring/freshwater/master/{{ $Freshwaters->created_at }}" method="post"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <select class="form-control form-control-sm " name="biota_id">
                                                                    ...
                                                                    @if (old('biota_id',$Freshwaters->biota_id)==$biota->id)
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <select class="form-control form-control-sm " name="location_id">
                                                                    ...
                                                                    @if (old('location_id',$Freshwaters->location_id)==$location->id)
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <div class="input-group date" id="reservationdate4" data-target-input="nearest">
                                                                    <input type="text" name="date" class="form-control datetimepicker-input form-control-sm @error('date') is-invalid @enderror " data-target="#reservationdate4" data-toggle="datetimepicker" value="{{ old('date',date('d-m-Y',strtotime($Freshwaters->date))) }}" />
                                                                    @error('date')
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input name="taxa_richness" type="number" step="0.01" class="form-control form-control-sm @error('taxa_richness') is-invalid @enderror" value="{{ old('taxa_richness',$Freshwaters->taxa_richness) }}" />
                                                                    @error('taxa_richness')
                                                                    <span class=" invalid-feedback">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input name="species_density" type="number" step="0.01" class="form-control form-control-sm @error('species_density') is-invalid @enderror" value="{{ old('species_density',$Freshwaters->species_density) }}">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input name="diversity_index" type="number" step="0.01" value="{{ old('diversity_index',$Freshwaters->diversity_index) }}" class="form-control form-control-sm @error('diversity_index') is-invalid @enderror">
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input name="evenness_value" type="number" step="0.01" class="form-control form-control-sm @error('evenness_value') is-invalid @enderror" value="{{ old('evenness_value',$Freshwaters->evenness_value) }}" />
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input name="dominance_index" type="number" step="0.01" class="form-control form-control-sm @error('dominance_index') is-invalid @enderror" value="{{ old('dominance_index',$Freshwaters->dominance_index) }}" />
