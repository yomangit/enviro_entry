                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input name="taxa_richness" type="number" step="0.01" class="form-control form-control-sm @error('taxa_richness') is-invalid @enderror" value="{{ old('taxa_richness') }}" />
                                                                    @error('taxa_richness')
                                                                    <span class=" invalid-feedback">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input name="species_density" type="number" step="0.01" class="form-control form-control-sm @error('species_density') is-invalid @enderror" value="{{ old('species_density') }}">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input name="diversity_index" type="number" step="0.01" value="{{ old('diversity_index') }}" class="form-control form-control-sm @error('diversity_index') is-invalid @enderror">
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input name="evenness_value" type="number" step="0.01" class="form-control form-control-sm @error('evenness_value') is-invalid @enderror" value="{{ old('evenness_value') }}" />
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input name="dominance_index" type="number" step="0.01" class="form-control form-control-sm @error('dominance_index') is-invalid @enderror" value="{{ old('dominance_index') }}" />
