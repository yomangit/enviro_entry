            ...
            <div class="">
                <div class="card card-primary card-outline">
                    <div class="card-header p-0 ">
                        ...
                        @endif
                        <a href="/monitoring/freshwater/biota/create" class="btn bg-gradient-secondary btn-xs ml-2 my-1"><i class="fas fa-plus mr-1 mt"></i>Add Data</a>
                        <a href="/exportbiota" class="btn  bg-gradient-secondary btn-xs my-1" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
                    ...
                    <div class="modal fade" id="modal-default">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="/importbiota" method="POST" enctype="multipart/form-data">
                                    @csrf
