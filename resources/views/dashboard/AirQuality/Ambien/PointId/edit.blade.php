            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="/airquality/ambien/pointid">{{ $tittle }}</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-olive card-outline">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="/airquality/ambien/pointid/{{ $PointID->id }}" method="post" enctype="multipart/form-data" autocomplete="off">
                        @method('put')
                        @csrf
                        <div class="row">
