                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="card-tools row">
                                                    <form action="/airquality/emission/pointid">
                                                ...
                                                <a href="/airquality/emission/pointid/create"
                                                class="btn bg-gradient-secondary btn-xs mt-2"><i
                                                    class="fas fa-plus mr-1 mt"></i>Add Data</a>
                                                    <a href="/export/emission/pointid" class="btn  bg-gradient-secondary btn-xs mt-2" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
                                                            ...
                                                            @foreach ($Codes as  $code)
                                                                <tr style="font-size: 12px">
                                                                    ...
                                                                    <td>
                                                                            ...
                                                                            {{-- <a href="/airquality/emission/pointid/{{ $code->failed_at }}"
                                                                                class="btn btn btn-outline-primary btn-xs btn-group"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title="Detail">
                                                                                <i class="far fa-eye"></i>
                                                                            </a> --}}
                                                                            <a href="/airquality/emission/pointid/{{ $code->id }}/edit"
                                                                            ...
                                                                            <form
                                                                                action="/airquality/emission/pointid/{{ $code->id }}"
                                                                                method="POST"
                                                                                class="d-inline">
                                                                                @method('delete')
                                                                                @csrf
                                            ...
                                            <div class="modal fade" id="modal-default">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/import/emission/pointid" method="POST" enctype="multipart/form-data">
                                                            @csrf
