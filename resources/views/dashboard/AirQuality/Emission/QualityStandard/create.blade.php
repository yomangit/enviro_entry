            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link"href="/airquality/emission/standard2/create" >Table Standard 2</a>
                        </li>
                    ...
                    <div class="tab-content" id="custom-content-below-tabContent">
                        <div class="tab-pane fade show active" id="custom-content-below-standard1" role="tabpanel" aria-labelledby="custom-content-below-standard1-tab">
                            ...
                            <div class="card-body">
                                <form action="/airquality/emission/standard" method="post" checked enctype="multipart/form-data" autocomplete="off">
                                    @csrf
