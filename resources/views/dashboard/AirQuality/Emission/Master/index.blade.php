                    ...
                    <div class="row my-2">
                        ...
                        <div class="col-6 d-flex justify-content-end">
                            <div class=" row form-inline">
                                <form action="/airquality/emission" class="form-inline  mt-1" autocomplete="off">
                                ...
                                <table role="grid" class="table table-striped table-bordered dt-responsive nowrap table-sm ">
                                    <thead class="table-info text-center ">
                                        <tr>
                                            ...
                                            <th colspan="7">Emission Air (Actual)</th>
                                            <th colspan="5">Emission Air (Corrected to 13% Oxygen at 25°C, 1 atm)</th>
