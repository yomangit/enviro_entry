                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="engine" type="text" class="form-control form-control-sm @error('engine') is-invalid @enderror" value="{{ old('engine',$Emission->engine) }}" />
                                            @error('engine')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="total_particulate_isokinetic_actual" type="text" class="form-control form-control-sm @error('total_particulate_isokinetic_actual') is-invalid @enderror" value="{{ old('total_particulate_isokinetic_actual',$Emission->total_particulate_isokinetic_actual) }}" />
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="sulfur_dioxide_so2_actual" type="text" class="form-control form-control-sm @error('sulfur_dioxide_so2_actual') is-invalid @enderror" value="{{ old('sulfur_dioxide_so2_actual',$Emission->sulfur_dioxide_so2_actual) }}" />
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="nitrogen_oxide_nox_as_nitrogen_dioxide_no2_actual" type="text" class="form-control form-control-sm @error('nitrogen_oxide_nox_as_nitrogen_dioxide_no2_actual') is-invalid @enderror" value="{{ old('nitrogen_oxide_nox_as_nitrogen_dioxide_no2_actual',$Emission->nitrogen_oxide_nox_as_nitrogen_dioxide_no2_actual) }}" />
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="nitrogen_oxide_nox_actual" type="text" class="form-control form-control-sm @error('nitrogen_oxide_nox_actual') is-invalid @enderror" value="{{ old('nitrogen_oxide_nox_actual',$Emission->nitrogen_oxide_nox_actual) }}" />
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="carbon_monoxide_co_actual" type="text" class="form-control form-control-sm @error('carbon_monoxide_co_actual') is-invalid @enderror" value="{{ old('carbon_monoxide_co_actual',$Emission->carbon_monoxide_co_actual) }}" />
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="carbon_dioxide_co" type="text" class="form-control form-control-sm @error('carbon_dioxide_co') is-invalid @enderror" value="{{ old('carbon_dioxide_co',$Emission->carbon_dioxide_co) }}" />
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="nitrogen_oxide_nox_as_nitrogen_dioxide_no2" type="text" class="form-control form-control-sm @error('nitrogen_oxide_nox_as_nitrogen_dioxide_no2') is-invalid @enderror" value="{{ old('nitrogen_oxide_nox_as_nitrogen_dioxide_no2',$Emission->nitrogen_oxide_nox_as_nitrogen_dioxide_no2) }}" />
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="form-group row">
                                        <label style="font-size: 12px" class="col-sm-4 col-form-label">Carbon Monoxide (CO) </label>
                                        <div class="col-sm-7">
                                            <input name="carbon_monoxide_co" type="text" class="form-control form-control-sm @error('carbon_monoxide_co') is-invalid @enderror" value="{{ old('carbon_monoxide_co',$Emission->carbon_monoxide_co) }}" />
