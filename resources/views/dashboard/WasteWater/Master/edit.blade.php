                ...
                <div class="card-body">
                    <div class="content">
                        <div class="col-12">
                            ...
                            <form action="/wastewater/{{ $Wastewater->id }}" method="post" enctype="multipart/form-data" autocomplete="off">
                                @method('put')
                                @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-control form-control-sm " name="point_id">
                                                    ...
                                                    @if (old('point_id',$Wastewater->point_id)==$code->id)
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group date" id="reservationdate4" data-target-input="nearest">
                                                    <input type="text" name="date" class="form-control datetimepicker-input form-control-sm @error('date') is-invalid @enderror " data-target="#reservationdate4" data-toggle="datetimepicker" value="{{ old('date',date('d-m-Y',strtotime($Wastewater->date))) }}" />
                                                    @error('date')
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="conductivity" type="text" class="form-control form-control-sm @error('conductivity') is-invalid @enderror" value="{{ old('conductivity',$Wastewater->conductivity) }}" />
                                                            @error('conductivity')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="turbidity" type="text" class="form-control form-control-sm @error('turbidity') is-invalid @enderror" value="{{ old('turbidity',$Wastewater->turbidity) }}" />
                                                            @error('turbidity')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="hardness" type="text" class="form-control form-control-sm @error('hardness') is-invalid @enderror" value="{{ old('hardness',$Wastewater->hardness) }}" />
                                                            @error('hardness')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="temperature" type="text" class="form-control form-control-sm @error('temperature') is-invalid @enderror" value="{{ old('temperature',$Wastewater->temperature) }}" />
                                                            @error('temperature')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="salinity" type="text" class="form-control form-control-sm @error('salinity') is-invalid @enderror" value="{{ old('salinity',$Wastewater->salinity) }}" />
                                                            @error('salinity')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="ph" type="text" class="form-control form-control-sm @error('ph') is-invalid @enderror" value="{{ old('ph',$Wastewater->ph) }}" />
                                                            @error('ph')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="bod" type="text" class="form-control form-control-sm @error('bod') is-invalid @enderror" value="{{ old('bod',$Wastewater->bod) }}" />
                                                            @error('bod')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="cod" type="text" class="form-control form-control-sm @error('cod') is-invalid @enderror" value="{{ old('cod',$Wastewater->cod) }}" />
                                                            @error('cod')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="pcdfs" type="text" class="form-control form-control-sm @error('pcdfs') is-invalid @enderror" value="{{ old('pcdfs',$Wastewater->pcdfs) }}" />
                                                            @error('pcdfs')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="pcdds" type="text" class="form-control form-control-sm @error('pcdds') is-invalid @enderror" value="{{ old('pcdds',$Wastewater->pcdds) }}" />
                                                            @error('pcdds')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
