                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <a href="/tailing/codeid/create"
                                                class="btn bg-gradient-secondary btn-xs mt-2"><i
                                                    class="fas fa-plus mr-1 mt"></i>Add Data</a>
                                                    <a href="/export/tailing/pointid" class="btn  bg-gradient-secondary btn-xs mt-2" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
                                                            ...
                                                            @foreach ($TailingCodeId as  $code)
                                                                <tr style="font-size: 12px">
                                                                    ...
                                                                    <td>
                                                                            ...
                                                                            <a href="/tailing/codeid/{{ $code->id }}/edit"
                                                    ...
                                                    <div class="card-tools row form-inline">
                                                        <div class="col-4">
                                                            <div class="d-flex justify-content-start">
                                                                <small>Showing {{ $TailingCodeId->firstItem() }} to {{
                                                                    $TailingCodeId->lastItem() }} of {{ $TailingCodeId->total() }}
                                                                </small>
                                                            </div>
                                                        </div>
                                                        <div class="col-8">
