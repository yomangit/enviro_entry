        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="/hydrometric/wlvp/{{ $Hydrometric->id }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control form-control-sm " name="codeHydrometric_id">
                                                @foreach ($code_units as $code)
                                                @if (old('codeHydrometric_id',$Hydrometric->codeHydrometric_id)===$code->id)
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group date" id="reservationdate4" data-target-input="nearest">
                                                <input type="text" name="date"
                                                    ...
                                                    value="{{ old( date('d-m-Y',strtotime('date')), date('d-m-Y',strtotime($Hydrometric->date))) }}" />
                                                @error('date')
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group date" id="timepicker"
                                                ...
                                                <input name="start_time" type="text"
                                                    value="{{ old('start_time', $Hydrometric->start_time) }}"
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group date" id="timepicker1"
                                                ...
                                                <input name="stop_time" type="text"
                                                    value="{{ old('stop_time', $Hydrometric->stop_time) }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    <input type="radio" name="water_condition" value="Pasang"
                                                   
                                                        {{ $Hydrometric->water_condition === 'Pasang' ? 'checked' : '' }}
                                                        id="waterCondition">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    <input type="radio" name="water_condition" value="Surut"
                                                        {{ $Hydrometric->water_condition === 'Surut' ? 'checked' : '' }}
                                                        id="waterCondition2">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    <input type="radio" name="water_color" value="Normal"
                                                        {{ $Hydrometric->water_color === 'Normal' ? 'checked' : '' }} 
                                                        id="watercolor1">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    <input type="radio" name="water_color" value="Agak Keruh"
                                                        {{ $Hydrometric->water_color === 'Agak Keruh'||'Agak keruh' ? 'checked' : '' }}
                                                        id="watercolor2">
                                                    <label style="font-size: 12px" class="mr-1"
                                                        for="watercolor2">AK
                                                    </label>
                                                </div>
                                                <div class="icheck-success d-inline">
                                                    <input type="radio" name="water_color" value="Keruh"
                                                        {{ $Hydrometric->water_color === 'Keruh' ? 'checked' : '' }} id="watercolor3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    ...
                                                    <input type="radio" name="odor" value="Ya"
                                                        {{ $Hydrometric->odor === 'Ya'||'Ada' ? 'checked' : '' }} id="waterScan1">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    ...
                                                    <input type="radio" name="odor" value="Tidak"
                                                        {{ $Hydrometric->odor === 'Tidak' ? 'checked' : '' }} id="waterScant2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    ...
                                                    <input type="radio" name="rain" value="Ya"
                                                        {{ $Hydrometric->rain === 'Ya'||'Ada' ? 'checked' : '' }} id="rain1">
                                                    <label style="font-size: 12px" for="rain1">Ya
                                                    </label>
                                                </div>
                                                <div class="icheck-success d-inline">
                                                    <input type="radio" name="rain" value="Tidak"
                                                        {{ $Hydrometric->rain === 'Tidak' ? 'checked' : '' }} id="rain2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    ...
                                                    <input type="radio" name="rain_during_sampling" value="Ya"
                                                        {{ $Hydrometric->rain_during_sampling === 'Ya' ? 'checked' : '' }}
                                                        id="rainSampling1">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    ...
                                                    <input type="radio" name="rain_during_sampling" value="Tidak"
                                                        {{ $Hydrometric->rain_during_sampling === 'Tidak' ? 'checked' : '' }}
                                                        id="rainSampling2">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    <input type="radio" name="oil_layer" value="Ya"
                                                        {{ $Hydrometric->oil_layer === 'Ya'||'Ada' ? 'checked' : '' }} id="oilLayer1">
                                                    <label style="font-size: 12px" for="oilLayer1">Ya
                                                    </label>
                                                </div>
                                                <div class="icheck-success d-inline">
                                                    <input type="radio" name="oil_layer" value="Tidak"
                                                        {{ $Hydrometric->oil_layer === 'Tidak' ? 'checked' : '' }} id="oilLayer2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="source_pollution" type="text"
                                                    ...
                                                    value="{{ old('source_pollution', $Hydrometric->source_pollution) }}" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="sampler" type="text"
                                                    ...
                                                    value="{{ old('sampler', $Hydrometric->sampler) }}" />
                                                @error('sampler')
                                                    <span class=" invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="remarks" type="text"
                                                    ...
                                                    value="{{ old('remarks', $Hydrometric->remarks) }}" />
                                                @error('remarks')
                                                    <span class=" invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                            ...
                            <div  class="card-footer d-flex justify-content-end">
                                <button style="width: 3cm" type="submit" class="btn  bg-gradient-success btn-sm ">Save</button>
                            </div>
                        </form>
