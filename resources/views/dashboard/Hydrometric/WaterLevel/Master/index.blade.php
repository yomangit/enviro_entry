            ...
            <div class="">
                <div class="card card-secondrary card-tabs">
                    <div class="card-header p-0">
                        ...
                        @endif
                        @can('admin')
                        <a href="/hydrometric/wlvp/point/" class="btn bg-gradient-info btn-xs ml-5 mt-3">Point ID</a>
                        <a href="/hydrometric/wlvp/qualitystandard/" class="btn bg-gradient-info btn-xs  mt-3">Quality
                            Standard </a>
                        @endcan
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header ">
                                            @if($code_units->count())
                                            @can('admin')
                                            <a href="/hydrometric/wlvp/create" class="btn bg-gradient-secondary btn-xs mt-2"><i class="fas fa-plus mr-1 mt"></i>Add Data</a>
                                            <a href="/export/hydrometric" class="btn  bg-gradient-secondary btn-xs mt-2" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-download mr-1"></i>Excel</a>
                                                    ...
                                                    <tr style="font-size: 12px">
                                                        ...
                                                        <td>
                                                            <div style="width: 80px">
                                                                ...
                                                                <!-- <a href="/hydrometric/wlvp/{{ $data->failed_at }}"
                                                                                class="btn btn btn-outline-primary btn-xs btn-group"
                                                                                data-toggle="tooltip" data-placement="top"
                                                                                title="Detail">
                                                                                <i class="far fa-eye"></i>
                                                                            </a> -->
                                                                <a href="/hydrometric/wlvp/{{ $data->id }}/edit" class="btn btn-outline-warning btn-xs btn-group" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <i class="fas fa-pen"></i>
                                                                </a>
                                                                <form action="/hydrometric/wlvp/{{ $data->id }}" method="POST" class="d-inline">
                                                                    @method('delete')
                                                                    @csrf
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <figure class="highcharts-figure">
                                                <div class="invoice p-3 mb-3 card-body" id="container"></div>
                                            </figure>
                                        </div>
                        ...
                        <div class="modal fade" id="modal-default">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/import/hydrometric" method="POST" enctype="multipart/form-data">
                                        @csrf
