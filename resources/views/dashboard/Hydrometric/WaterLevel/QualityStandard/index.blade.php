                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="card-tools row">
                                                    {{-- <form action="/hydrometric/wlvp/qualitystandard" class="form-inline">
                                                ...
                                                <a href="/hydrometric/wlvp/qualitystandard/create"
                                                class="btn bg-gradient-secondary btn-xs mt-2"><i
                                                    class="fas fa-plus mr-1 mt"></i>Add Data</a>
                                                    <a href="/export/qualitystandard" class="btn  bg-gradient-secondary btn-xs mt-2" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
                                                        ...
                                                        @endphp
                                                            @foreach ($QualityStandard as  $point_id)
                                                                <tr style="font-size: 12px">
                                                                    <td>{{ $no++ }}</td>
                                                                    <td>
                                                                            {{-- <a href="/hydrometric/wlvp/qualitystandard/{{ $point_id->failed_at }}"
                                                                                class="btn btn btn-outline-primary btn-xs btn-group"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title="Detail">
                                                                                <i class="far fa-eye"></i>
                                                                            </a> --}}
                                                                            <a href="/hydrometric/wlvp/qualitystandard/{{ $point_id->id }}/edit"
                                                                            ...
                                                                            <form
                                                                                action="/hydrometric/wlvp/qualitystandard/{{ $point_id->id }}"
                                                                                method="POST"
                                                                                class="d-inline">
                                                                                @method('delete')
                                                                                @csrf
