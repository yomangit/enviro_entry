            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="/hydrometric/dischargemanual/pointid">{{ $tittle }}</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-olive card-outline">
                <div class="card-header p-0 ">
                    <div class=" ml-1 card-title">Form Edit</div>
                </div>

                <!-- /.card-header -->
                <form action="/hydrometric/dischargemanual/pointid/{{ $PointID->id }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    @method('put')
                    @csrf
                    <div class="card-body">
