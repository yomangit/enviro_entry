        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header p-0 ">
                    ...
                    @endif
                    <div class="card-title ml-1">Form Input</div>
                </div>
                <!-- /.card-header -->
                <form action="/hydrometric/dischargemanual/pointid" method="post" checked enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="card-body">
                        <div class="row">
