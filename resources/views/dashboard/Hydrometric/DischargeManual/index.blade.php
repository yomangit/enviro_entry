                        ...
                        <div class="modal fade" id="modal-default">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/import/dischargemanual" method="POST" enctype="multipart/form-data">
                                        @csrf
