                ...
                <div class="card card-primary card-outline">
                    <div class="card-header p-0 p-2">
                        ...
                        <div class="card-tools p-2 mr-2">
                            ...
                            <form action="/weather/rainfall/rainfallpointid">
                                    ...
                                    <tr style="font-size: 12px">
                                        ...
                                        <td>
                                            <div style="">
                                                ...
                                                <form action="/weather/rainfall/rainfallpointid/{{ $code->id }}" method="POST" class="d-inline">
                                                    @method('delete')
                                                    @csrf
                    ...
                    <div class="modal fade" id="modal-default">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="/import/rainfallpointid" method="POST" enctype="multipart/form-data">
                                    @csrf
