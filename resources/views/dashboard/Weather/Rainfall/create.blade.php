    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <!-- /.card-header -->
                <form action="/weather/rainfall" method="post" checked enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="rainfall" type="text" class="form-control form-control-sm @error('rainfall') is-invalid @enderror" value="{{ old('rainfall') }}" />
                                            @error('rainfall')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
