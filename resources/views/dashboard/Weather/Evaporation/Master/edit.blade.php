                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="input-group date" id="reservationdate4" data-target-input="nearest">
                                            <input type="text" name="date" class="form-control datetimepicker-input form-control-sm @error('date') is-invalid @enderror " data-target="#reservationdate4" data-toggle="datetimepicker" value="{{ old('date',date('Y-m-d',strtotime($Evaporation->date))) }}" />
                                            @error('date')
                                    ...
                                    <div class="col-sm-7">
                                        <div class="input-group date" id="timepicker"
                                            ...
                                            <input name="time_observation" type="text"
                                                value="{{ old('time_observation',$Evaporation->time_observation) }}"
                           ...
                           <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="day_rainfall" type="text" class="form-control form-control-sm @error('day_rainfall') is-invalid @enderror" value="{{ old('day_rainfall',$Evaporation->day_rainfall) }}" />
                                            @error('day_rainfall')
                                            <span class=" invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                           ...
                           <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="initial_water_elevation" type="text" class="form-control form-control-sm @error('initial_water_elevation') is-invalid @enderror" value="{{ old('initial_water_elevation',$Evaporation->initial_water_elevation) }}" />
                           ...
                           <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="final_water_elevation" type="text" class="form-control form-control-sm @error('final_water_elevation') is-invalid @enderror" value="{{ old('final_water_elevation',$Evaporation->final_water_elevation) }}" />
