            ...
            <div class="card card-primary card-outline">
                <div class="card-header p-0 ">
                    ...
                    <div class="card-tools row p-2 mr-1 form-inline">
                        <form action="/surfacewater/qualityperiode/codesample">
                    ...
                    <a href="/surfacewater/qualityperiode/codesample/create" class="btn bg-gradient-secondary btn-xs ml-2 m-1"><i class="fas fa-plus  mt"></i>Add Data</a>
                    <a href="/exportcodesamplesw" class="btn  bg-gradient-secondary btn-xs m-1" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download "></i>Excel</a>
                            ...
                            <tbody style="text-align: center">
                                ...
                                <tr style="font-size: 12px">
                                    ...
                                    <td>
                                        ...
                                        <a href="/surfacewater/qualityperiode/codesample/{{ $code->id }}/edit" class="btn btn-outline-warning btn-xs btn-group" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="fas fa-pen"></i>
                                        </a>
                                        <form action="/surfacewater/qualityperiode/codesample/{{ $code->id }}" method="POST" class="d-inline">
                                            @method('delete')
                                            @csrf
