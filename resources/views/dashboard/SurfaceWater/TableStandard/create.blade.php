        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    ...
                    <form action="/surfacewater/standardtable" method="post" checked enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="tab-content" id="custom-content-below-tabContent">
                            <div class="col-12 col-md-6 col-sm-10 mb-2">
                                <div class="row ">
                                    ...
                                    <div class="col-sm-6 ">
                                        <input type="text" name="name" value="{{old("name") }}" class=" @error('name') is-invalid @enderror form-control form-control-sm">
                                        @error('name')
