                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group date" id="reservationdate4" data-target-input="nearest">
                                                <input type="text" name="date"
                                                    ...
                                                    value="{{ old( date('d-m-Y',strtotime('date')), date('d-m-Y',strtotime($Input->date))) }}" />
                                                @error('date')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="temperatur" type="number" step="0.01"
                                                    ...
                                                    value="{{ old('temperatur', $Input->temperatur) }}" />
                                                @error('temperatur')
                                                    <span
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="conductivity" type="number" step="0.01"
                                                    ...
                                                    value="{{ old('conductivity', $Input->conductivity) }}" />
                                                @error('conductivity')
                                                    <span class=" invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="turbidity" type="number" step="0.01"
                                                    ...
                                                    value="{{ old('turbidity', $Input->turbidity) }}" />
                                                @error('turbidity')
                                                    <span class=" invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="salinity" type="number" step="0.01"
                                                    ...
                                                    value="{{ old('salinity', $Input->salinity) }}" />
                                                @error('salinity')
                                                    <span class=" invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="lvl_lgr" type="number" step="0.01"
                                                        ...
                                                        value="{{ old('lvl_lgr', $Input->lvl_lgr) }}">
                                                    @error('lvl_lgr')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="debit_s" type="number" step="0.01"
                                                        ...
                                                        value="{{ old('debit_s', $Input->debit_s) }}">
                                                    @error('debit_s')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="debit_d" type="number" step="0.01"
                                                        ...
                                                        value="{{ old('debit_d', $Input->debit_d) }}">
                                                    @error('debit_d')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    <input type="radio" name="water_condition" value="Pasang"
                                                        ...
                                                        {{ $Input->water_condition === 'Pasang' ? 'checked' : '' }}
                                                        id="waterCondition">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    <input type="radio" name="water_condition" value="Surut"
                                                        {{ $Input->water_condition === 'Surut' ? 'checked' : '' }}
                                                        id="waterCondition2">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    <input type="radio" name="water_color" value="Normal"
                                                        {{ $Input->water_color === 'Normal' ? 'checked' : '' }} 
                                                        id="watercolor1">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    <input type="radio" name="water_color" value="Agak Keruh"
                                                        {{ $Input->water_color === 'Agak Keruh'||'Agak keruh' ? 'checked' : '' }}
                                                        id="watercolor2">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    <input type="radio" name="water_color" value="Keruh"
                                                        {{ $Input->water_color === 'Keruh' ? 'checked' : '' }} id="watercolor3">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    ...
                                                    <input type="radio" name="odor" value="Ya"
                                                        {{ $Input->odor === 'Ya'||'Ada' ? 'checked' : '' }} id="waterScan1">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    ...
                                                    <input type="radio" name="odor" value="Tidak"
                                                        {{ $Input->odor === 'Tidak' ? 'checked' : '' }} id="waterScant2">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="icheck-success d-inline col-sm-7">
                                                    ...
                                                    <input type="radio" name="rain_during_sampling" value="Ya"
                                                        {{ $Input->rain_during_sampling === 'Ya' ? 'checked' : '' }}
                                                        id="rainSampling1">
                                                ...
                                                <div class="icheck-success d-inline">
                                                    ...
                                                    <input type="radio" name="rain_during_sampling" value="Tidak"
                                                        {{ $Input->rain_during_sampling === 'Tidak' ? 'checked' : '' }}
                                                        id="rainSampling2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input name="source_pollution" type="text"
                                                    ...
                                                    value="{{ old('source_pollution', $Input->source_pollution) }}" />
