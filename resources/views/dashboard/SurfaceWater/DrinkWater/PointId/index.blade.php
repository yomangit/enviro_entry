                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <a href="/surfacewater/drinkwater/pointid/create"
                                                class="btn bg-gradient-secondary btn-xs mt-2"><i
                                                    class="fas fa-plus mr-1 mt"></i>Add Data</a>
                                                    <a href="/export/drinkwater/pointid" class="btn  bg-gradient-secondary btn-xs mt-2" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
                                                            ...
                                                            @foreach ($PointID as  $code)
                                                                <tr style="font-size: 12px">
                                                                    ...
                                                                    <td>
                                                                            ...
                                                                            <a href="/surfacewater/drinkwater/pointid/{{ $code->id }}/edit"
                                                                            ...
                                                                            <form
                                                                                action="/surfacewater/drinkwater/pointid/{{ $code->id }}"
                                                                                method="POST"
                                                                                class="d-inline">
                                                                                @method('delete')
                                                                                @csrf
