                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="permanganate_number_as_kmno4" type="text" class="form-control form-control-sm @error('permanganate_number_as_kmno4') is-invalid @enderror" value="{{ old('permanganate_number_as_kmno4',$DrinkWater->permanganate_number_as_kmno4) }}" />
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="surfactant" type="text" class="form-control form-control-sm @error('surfactant') is-invalid @enderror" value="{{ old('surfactant',$DrinkWater->surfactant) }}" />
                                                            @error('surfactant')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="benzene" type="text" class="form-control form-control-sm @error('benzene') is-invalid @enderror" value="{{ old('benzene',$DrinkWater->benzene) }}" />
                                                            @error('benzene')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
											...
											<div class="col-12 col-sm-4">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="total_pesticides_as_organo_chlorine_pesticides" type="text" class="form-control form-control-sm @error('total_pesticides_as_organo_chlorine_pesticides') is-invalid @enderror" value="{{ old('total_pesticides_as_organo_chlorine_pesticides',$DrinkWater->total_pesticides_as_organo_chlorine_pesticides) }}" />
