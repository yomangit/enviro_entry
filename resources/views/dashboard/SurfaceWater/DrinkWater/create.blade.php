        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header p-0 ">
                    ...
                    @endif
                   <div class="card-title m-1">Form Input</div>
                </div>
                ...
                <ul class="nav nav-tabs mb-2" id="custom-content-above-tab" role="tablist">
                    ...
                    <form action="/surfacewater/drinkwater" method="post" checked enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="color" type="text" class="form-control form-control-sm @error('color') is-invalid @enderror" value="{{ old('color') }}" />
                                                            @error('color')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="odor" type="text" class="form-control form-control-sm @error('odor') is-invalid @enderror" value="{{ old('odor') }}" />
                                                            @error('odor')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="taste" type="text" class="form-control form-control-sm @error('taste') is-invalid @enderror" value="{{ old('taste') }}" />
                                                            @error('taste')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="chloride" type="text" class="form-control form-control-sm @error('chloride') is-invalid @enderror" value="{{ old('chloride') }}" />
                                                            @error('chloride')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="residual_chlorine" type="text" class="form-control form-control-sm @error('residual_chlorine') is-invalid @enderror" value="{{ old('residual_chlorine') }}" />
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="ammonia_nnh3" type="text" class="form-control form-control-sm @error('ammonia_nnh3') is-invalid @enderror" value="{{ old('ammonia_nnh3') }}" />
                                                            @error('ammonia_nnh3')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="nitrate_no2" type="text" class="form-control form-control-sm @error('nitrate_no2') is-invalid @enderror" value="{{ old('nitrate_no2') }}" />
                                                            @error('nitrate_no2')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input name="c_coli" type="text" class="form-control form-control-sm @error('c_coli') is-invalid @enderror" value="{{ old('c_coli') }}" />
                                                            @error('c_coli')
                                                            <span class=" invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                        </div>
