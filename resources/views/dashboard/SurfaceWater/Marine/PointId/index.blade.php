            ...
            <div class="card card-primary card-outline">
                <div class="card-header p-0 ">
                    ...
                    <div class="card-tools row p-2 mr-1 form-inline">
                        <form action="/surfacewater/marinesurfacewater/pointid">
                    ...
                    <a href="/surfacewater/marinesurfacewater/pointid/create" class="btn bg-gradient-secondary btn-xs ml-2 my-1"><i class="fas fa-plus ml-1 "></i>Add Data</a>
                    <a href="/export/marinesurfacewater/pointid" class="btn  bg-gradient-secondary btn-xs my-1" data-toggle="tooltip" data-placement="top" title="download"><i class="fas fa-download mr-1"></i>Excel</a>
                            ...
                            <tbody style="text-align: center">
                                ...
                                <tr style="font-size: 12px">
                                    ...
                                    <td>
                                        ...
                                        {{-- <a href="/surfacewater/marinesurfacewater/pointid/{{ $code->failed_at }}"
                                        class="btn btn btn-outline-primary btn-xs btn-group"
                                        data-toggle="tooltip"
                                        data-placement="top" title="Detail">
                                        <i class="far fa-eye"></i>
                                        </a> --}}
                                        <a href="/surfacewater/marinesurfacewater/pointid/{{ $code->id }}/edit" class="btn btn-outline-warning btn-xs btn-group" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="fas fa-pen"></i>
                                        </a>
                                        <form action="/surfacewater/marinesurfacewater/pointid/{{ $code->id }}" method="POST" class="d-inline">
                                            @method('delete')
                                            @csrf
                ...
                <div class="card-footer p-0 ">
                    <div class="row ">
                        <div class="col-6 col-md-4 form-inline ">
                            ...
                            <h6 class="ml-2 p-0">Showing {{ $PointID->firstItem() }} to
                ...
                <div class="modal fade" id="modal-default">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="/import/marinesurfacewater/pointid" method="POST" enctype="multipart/form-data">
                                @csrf
